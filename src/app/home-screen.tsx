        ...
        <div className="bg-primary">
                    ...
                    <div className="flex flex-col gap-8 lg:w-[60vw] lg:pr-12">
                        ...
                        <div className="flex flex-col gap-6">
                            <div className="flex gap-4">
                                <CheckCircle className="mt-1 size-6 shrink-0 text-fg-brand-primary" aria-hidden="true" />
            ...
            <section className="bg-brand-secondary-solid px-4 py-16 md:px-8 lg:px-16 lg:py-24">
                <div className="mx-auto flex w-full max-w-6xl flex-col gap-10">
                    ...
                    <div className="grid w-full gap-12 lg:gap-x-16 lg:grid-cols-[1.1fr_0.9fr] lg:items-center">
