...
export const styles = sortCx({
    ...
    colors: {
        ...
        "brand-secondary": {
            root: [
                "bg-brand-secondary-solid text-white shadow-xs-skeumorphic ring-1 ring-transparent ring-inset hover:bg-brand-secondary-solid_hover data-loading:bg-brand-secondary-solid_hover",
                // Inner border gradient
                "before:absolute before:inset-px before:border before:border-white/12 before:mask-b-from-0%",
                // Disabled styles
                "disabled:bg-disabled disabled:shadow-xs disabled:ring-disabled_subtle",
                // Icon styles
                "*:data-icon:text-button-brand-secondary-icon hover:*:data-icon:text-button-brand-secondary-icon_hover",
            ].join(" "),
        },
        "secondary-brand": {
            root: [
                "bg-primary text-brand-secondary-700 shadow-xs-skeumorphic ring-2 ring-brand-secondary ring-inset hover:bg-brand-secondary-50 hover:text-brand-secondary-800 data-loading:bg-brand-secondary-50",
                // Disabled styles
                "disabled:shadow-xs disabled:ring-disabled_subtle",
                // Icon styles
                "*:data-icon:text-brand-secondary-600 hover:*:data-icon:text-brand-secondary-700",
            ].join(" "),
        },
        "secondary-brand-outline": {
            root: [
                "bg-transparent text-brand-secondary-700 shadow-xs-skeumorphic ring-[2px] ring-brand-secondary ring-inset hover:bg-brand-secondary-50 hover:text-brand-secondary-800 data-loading:bg-brand-secondary-50",
                // Disabled styles
                "disabled:shadow-xs disabled:ring-disabled_subtle",
                // Icon styles
                "*:data-icon:text-brand-secondary-600 hover:*:data-icon:text-brand-secondary-700",
        ...
        "secondary-on-brand": {
            root: [
                "bg-transparent text-white shadow-xs-skeumorphic ring-2 ring-white ring-inset",
                // Disabled styles
                "disabled:shadow-xs disabled:ring-disabled_subtle",
                // Icon styles
                "*:data-icon:text-fg-white",
            ].join(" "),
        },
        tertiary: {
            root: [
